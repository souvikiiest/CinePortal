...
export default function MovieDetails({movie,handleCancel}){
const {cartValue, setcartValue} = useContext(MovieContext);
const [popup,setPopup] = useState({visible:false,message:""})
const handleCartAdd = (id)=>{
  const found = cartValue.find(value=>value.id === id);
      if(!found){
      setcartValue([
        ...cartValue,
        movie
              ...
              <div className="p-5 lg:p-11">
                ...
                <div className="grid lg:grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span onClick={()=>handleCartAdd(movie.id)}>${movie.price} | Add to Cart</span>
                  </a>
                  <a
